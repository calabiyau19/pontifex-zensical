---
title: Pontifex
description: Linux self-hosting documentation
hide: 
  - navigation 
  - toc
---
...
-   :simple-proxmox:{ .lg .middle } __Proxmox__
    ...
    ---
    [![Proxmox](assets/images/card-proxmox.svg)](proxmox/index.md)
...
-   :material-application:{ .lg .middle } __Applications__
    ...
    ---
    [![Applications](assets/images/card-applications.svg)](applications/index.md)
...
-   :material-network:{ .lg .middle } __Networking__
    ...
    ---
    [![Networking](assets/images/card-networking.svg)](networking/index.md)
...
-   :fontawesome-brands-linux:{ .lg .middle } __Linux__
    ...
    ---
    [![Linux](assets/images/card-linux.svg)](linux/index.md)
...
-   :material-wrench:{ .lg .middle } __Projects__
    ...
    ---
    [![Projects](assets/images/card-projects.svg)](projects/index.md)
...
-   :material-web:{ .lg .middle } __Websites__
    ...
    ---
    [![Websites](assets/images/card-websites.svg)](websites/index.md)
